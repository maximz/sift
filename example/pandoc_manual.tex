...
\texttt{gfm} output, ATX headers are always used.) This option also
...
\href{https://ctan.org/pkg/report}{\texttt{report}}, and
\href{https://ctan.org/pkg/book}{\texttt{book}}; the
\href{https://ctan.org/pkg/koma-script}{KOMA-Script} equivalents,
\texttt{scrartcl}, \texttt{scrreprt}, and \texttt{scrbook}, which
...
\texttt{reference-section-title} in the metadata, or put the header at
...
\item
  ...
  include dangerous content in attributes for headers, spans, and code
